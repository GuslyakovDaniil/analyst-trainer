...
* **Прохождение заданий:** Поддержка 3 типов вопросов: закрытые тесты, поиск ошибок и открытые задания.
...
* **Гусляков Даниил** — *Тимлид, Backend-разработчик, DevOps*
    * Разработка Backend-сервиса на Java (Javalin, алгоритмы автопроверки, генерация JWT, хэширование BCrypt).
    * Проектирование базы данных PostgreSQL (схема, SQL-миграции, DAO-слой).
    * Реализация сложной бизнес-логики: система геймификации, подсчет баллов, маршрутизация панели администратора.
    * Контейнеризация проекта (Dockerfile, docker-compose) и настройка окружения.

* **Бычкова Екатерина** — *Frontend-разработчик, UI/UX Дизайнер*
    * Прототипирование пользовательских интерфейсов в Figma.
    * Написание Frontend-кода (HTML, CSS, Vanilla JS).
    * Реализация взаимодействия клиентской части с REST API.

* **Богословский Евгений** — *Бизнес/системный аналитик*
    * Анализ архитектуры и REST API, формализация бизнес-логики, подготовка материалов и структуры для презентации.

* **Мулюкова Дилара** — *QA Engineer*
...
* **Носовко Кристина** — *Технический писатель*
    * Подготовка итогового отчёта, документирование проекта, текстовое описание архитектуры и ER-модели базы данных.